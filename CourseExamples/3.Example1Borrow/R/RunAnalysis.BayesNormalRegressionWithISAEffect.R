...
#
#############################################################################################################################.
RunAnalysis.BayesNormalRegressionWithISAEffect <- function( cAnalysis, lDataAna,  nISAAnalysisIndx, bIsFinalISAAnalysis, cRandomizer )
{
    #Sprint( paste( "RunAnalysis.BayesNormalRegressionWithISAEffect"))
    ...
    lData <- list( nQtyPats = length( vTrt ), 
                   vY = vOut,
                   vTreatment = vTrt,
                   vExternalControl = vExternalControl,
    ...
    lPost      <- SamplePosteriorWithISAEffect( lData, cAnalysis, nQtySamplesPerChain , dDelta )
